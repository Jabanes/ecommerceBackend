...
ACCEPT_SANDBOX_PAYMENTS_FOR_TEST = os.getenv('ACCEPT_SANDBOX_PAYMENTS_FOR_TEST', 'True') == 'True'
AUTO_CAPTURE_PAYMENT_FOR_TEST = os.getenv('AUTO_CAPTURE_PAYMENT_FOR_TEST', 'True') == 'True'
AUTO_FULFILL_ORDER_FOR_TEST = os.getenv('AUTO_FULFILL_ORDER_FOR_TEST', 'True') == 'True'
